...
Donation.create!(grant: g1, donor: 'Brian O.', amount_cents: 20000, date: DateTime.now - 11.months)
...
Donation.create!(grant: g1, donor: 'Christina O.', amount_cents: 29000, date: DateTime.now - 1.month)
...
Disbursement.create!(grant: g1, name: 'Reinhold Family', landlord: 'Riverview Suites', move_in_amount_cents: 20500, prevention_amount_cents: 20000, number_children: 1, date: DateTime.now - 2.months)
...
Disbursement.create!(grant: g1, name: 'Uriben Family', landlord: 'Riverview Suites', move_in_amount_cents: 20030, prevention_amount_cents: 20100, number_children: 1, date: DateTime.now - 2.months)
Disbursement.create!(grant: g1, name: 'Sheeran Family', landlord: 'Johnny Rose', move_in_amount_cents: 1000, prevention_amount_cents: 0, number_children: 3, date: DateTime.now - 8.months)
...
Disbursement.create!(grant: g1, name: 'Reinhold Family', landlord: 'Riverview Suites', move_in_amount_cents: 20500, prevention_amount_cents: 20000, number_children: 1, date: DateTime.now - 12.months)
...
Disbursement.create!(grant: g1, name: 'Uriben Family', landlord: 'Riverview Suites', move_in_amount_cents: 20030, prevention_amount_cents: 20100, number_children: 1, date: DateTime.now - 12.months)
Disbursement.create!(grant: g1, name: 'Sheeran Family', landlord: 'Johnny Rose', move_in_amount_cents: 1000, prevention_amount_cents: 0, number_children: 3, date: DateTime.now - 12.months)
